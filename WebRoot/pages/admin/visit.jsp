...
.top_menu a {
	...
	<section style="padding-top: 10px; padding-left: 20px;">
				...
				<div class="alert fade in" style="padding-bottom:25px;margin-top:20px">
					...
					<div style="margin-top:20px">
           			...
           			<ul>
						...
						<li class="nav"><a href="search/patient_findVisitPager.action" class="selected">病次列表</a></li>
			...
			<div class="searchPanal" style="float: left; width: 75%;margin-top:20px">
				...
				<div class="searchbar">
					<div>
					<form action="search/patient_findVisitPager.action" id="searchForm">
						<label style="font-weight:bold">姓名:</label>&nbsp;<input type="text" value="${visit.patientName}" name="visit.patientName" size="16"/>&nbsp;&nbsp;&nbsp;
						<label style="font-weight:bold">ID号:</label>&nbsp;<input type="text" value="${visit.patientId}" name="visit.patientId" size="16"/>&nbsp;&nbsp;&nbsp;
						<label style="font-weight:bold">院次:</label>&nbsp;<input type="text" value="${visit.visitId}" name="visit.visitId" size="16"/>&nbsp;&nbsp;&nbsp;
						<label style="font-weight:bold">科室:</label>&nbsp;<input type="text" value="${visit.deptDischargeFrom}" name="visit.deptDischargeFrom" size="16"/>
				...
				<table class="table table-bordered" style="padding-bottom:20px;">
					...
					<tbody style="text-align:center">
						<s:iterator value="visitList" id="visit" status="index">
							<tr>
								<td>
									<s:property value="page.rowFrom+#index.index + 1" />
								</td>
								<td>
									<s:property value="#visit.patientName" />
								</td>
								<td>
									<s:property value="#visit.patientId" />
								</td>
								<td>
									<s:property value="#visit.visitId" />
								</td>
								<td>
									<s:property value="#visit.attendingDoctor" />
								</td>
								<td>
									<s:property value="#visit.consultingDoctor" />
								</td>
								<td>
									<s:property value="#visit.admissionCause" />
								</td>
								<td>
									<s:property value="#visit.deptDischargeFrom" />
								</td>
								<td>
									<s:date format="yyyy-MM-dd" name="#visit.admissionDateTime"/>
								</td>
								<td>
									<s:property value="#visit.patientClass" />
								</td>
								<td>
									<s:if test="#visit.addFlag==1">
										新增
									</s:if>
									<s:else>
										原有
